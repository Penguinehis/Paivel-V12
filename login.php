...
<head>
    ...
    <meta name="msapplication-TileColor" content="#670eb4">
    <meta name="theme-color" content="#670eb4">
...
<!-- ============================================================== -->
<section id="wrapper">
    <div class="login-register" style="background-image: linear-gradient(0deg, #ffffff, #670eb4);">        
        <div class="login-box card">
            <div class="card-body">
                <form action="validacao.php" method="post">
                    <form class="form-horizontal form-../material" id="loginform" action="home.php">
                        <center><h3><i class="fa fa-linux"></i> CRACKED<b>PENGUIN</b></h3></center>
                        <div class="form-group ">
                            <div class="col-xs-12">
                ...
                <div class="form-group m-b-0">
                    <div class="col-sm-12 text-center">
                        ...
                        Todos Direitos Reservados <a href="https://t.me/sshplus" class="text-primary m-l-5"><b>CRACKEDPENGUIN</b></a></p>
                    </div>
                </div>
            </div>
        </div>
