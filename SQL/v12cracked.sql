...
--
-- Host: localhost
-- Generation Time: 03-Set-2019 às 14:07
...
) ENGINE=MyISAM AUTO_INCREMENT=4479 DEFAULT CHARSET=latin1;
...
--
ALTER TABLE `acesso_servidor`
MODIFY `id_acesso_servidor` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=18;
--
...
--
ALTER TABLE `hist_usuario_ssh_online`
MODIFY `id_hist_usrSSH` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4479;
--
...
--
ALTER TABLE `sms`
MODIFY `id_sms` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=117;
--
...
--
ALTER TABLE `usuario`
MODIFY `id_usuario` int(60) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=17;
--
-- AUTO_INCREMENT for table `usuario_ssh`
--
ALTER TABLE `usuario_ssh`
MODIFY `id_usuario_ssh` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=132;
--
