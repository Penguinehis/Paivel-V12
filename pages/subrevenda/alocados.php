...
<td>
  ...
  <small><a data-toggle="modal" href="#myModal<?php echo $row['id_acesso_servidor'];?>" class="btn-sm btn-danger"><i class="fa fa-trash-o"></i></a>&nbsp;&nbsp;&nbsp;
    <a data-toggle="modal" href="#squarespaceModal<?php echo $row['id_acesso_servidor'];?>" class="btn-sm btn-warning"><i class="fa fa-list-alt"></i></a></small>
