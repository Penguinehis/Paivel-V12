    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-body printableArea">
                <h3><b>CRACKEDPENGUIN, Inc.</b>Fatura N°#<?php echo $fatu['id']; ?> Data: <?php echo $dia;?>/<?php echo $mes;?>/<?php echo $ano;?> </h3>
                        ...
                        <div class="pull-left">
                            <address>
                                ...
                                <p class="text-muted m-l-5">Sao paulo, SP
                                    <br/> Telefone: (11) 97343-1010
                                    <br/> Email: admin@gmail.com
                                    <br/> Telegram: @user</p>
                                    <br/> (Aceitamos Depósito e Transfêrencia• Bancaria)</p>
                                    <br/> •Conta: Soliciar ao vendedor</p>
                                </address>
                            </div>
